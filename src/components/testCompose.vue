<template>
    <v-sheet rounded="xl" color="white" elevation="6" min-height="90vh">
		...
		<input class="add" ref="file" type="file" name="file" id="file" accept="text/*" multiple style="display: none"/>
		<v-btn class = "white--text " color = "blue-grey darken-2" bottom @click="clickFile">문서추가</v-btn>
    </v-sheet>
</template>
